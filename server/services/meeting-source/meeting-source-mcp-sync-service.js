...
// sentence splitter at ingest time. They are generated by the external runtime
// and written back through meetingAutomationService.recordCandidates. At ingest
// the candidate outputs are created as non-null awaiting-runtime placeholders.
function buildAwaitingExternalRuntimeCandidates() {
    return {
        task_candidates: [],
        decision_candidates: [],
        follow_up_draft: {
...
export class MeetingSourceMcpSyncService {
    ...
    _buildReviewPackageDraft(cluster, { actor = null, scope = {} } = {}) {
        ...
        // Candidates start empty. The external runtime fills task_candidates,
        // decision_candidates, and follow_up_draft when it writes back the result.
        const { task_candidates: taskCandidates, decision_candidates: decisionCandidates, follow_up_draft: followUpDraft } = buildAwaitingExternalRuntimeCandidates();
        return {
