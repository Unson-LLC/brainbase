...
const SEMANTIC_SNS_BLOCK_PATTERN = /補助金|助成金|融資|返金|銀行口座|税務リスク|役員報酬|未払い|資金調達|キャッシュ不足|保証協会|不審メール|乗っ取り|フィッシング|迷惑メール|Outlook|Entra|セキュリティ診断|暫定ルート|PC貸出|Pマーク|IFA|MA仲介|オンサイト|物理セキュリティ|ネットワークアクセス|システムアクセス/u;
