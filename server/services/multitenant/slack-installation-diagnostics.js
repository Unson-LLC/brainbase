const FAILURE_CODES_BY_STAGE = Object.freeze({
    oauth_exchange: new Set([
        ...
        'OAUTH_EXCHANGE_INVALID_CODE', 'OAUTH_EXCHANGE_REDIRECT_MISMATCH',
        'OAUTH_EXCHANGE_CLIENT_CREDENTIAL_REJECTED', 'OAUTH_EXCHANGE_FLOW_MISMATCH',
        'OAUTH_EXCHANGE_PKCE_REJECTED', 'OAUTH_EXCHANGE_ACCESS_DENIED',
