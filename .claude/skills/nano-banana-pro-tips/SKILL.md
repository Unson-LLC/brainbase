...
Geminiの画像生成モデル「Nano Banana Pro」の活用テクニック集。

## 出典

Google Gemini公式note（2025年12月8日）

## Nano Banana Proの5つの特徴

### ① 驚異の「文字描写力」(SoTA Text Rendering)

- 日本語を正確に画像内に描写可能
- ロゴデザイン、ポスタータイトル、看板の文字が違和感なく生成
- 情報がぎっしり詰まったスライド画像や複雑な数式も生成可能

### ② 最大2Kの高解像度と自由なアスペクト比

- 印刷用途や大画面表示にも耐えうる画質
- 映画のようなワイドスクリーン、スマホ壁紙用の縦長サイズなど自由指定可能
- 「4Kにアップスケールして」で高解像度化

### ③ より広範囲な知識を強化（Enhanced World Knowledge）

- 文化的な背景、専門的なツール、複雑なシチュエーションを理解
...
- 「写真をアニメ調に」「スケッチを油絵風に」
- 元の構図やニュアンスを壊さず画風だけをコントロール
- 例：「緻密なクロシェット編みに作り替えて」「昔のゲームのような荒いドット絵に変換して」

### ⑤ 進化した「写真合成」

- 最大6枚の画像を自然に統合
- 光の向き、影の落ち方、質感まで自動調整
- 例：「添付画像を組み合わせて、キャラクターがモデルのようなポーズで海辺で撮影されている様子を作って」
