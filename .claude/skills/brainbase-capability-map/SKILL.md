...
| `judgment.resolve` | `judgment.resolve.yml` | Host resolves canonical conversation context before model generation and exposes only the relevant judgment DAG branches and policies |
