...
describe('POST /api/open-file', () => {
    ...
    describe('基本機能: ファイルを開く', () => {
        it('should open a file and return success', async () => {
            ...
            const response = await request(app)
                .post('/api/open-file')
                .send({ path: '/path/to/workspace/test.md', mode: 'file' });
        ...
        it('should reveal file in Finder when mode is reveal', async () => {
            ...
            const response = await request(app)
                .post('/api/open-file')
                .send({ path: '/path/to/workspace/test.md', mode: 'reveal' });
    ...
    describe('コマンド実行の検証', () => {
        it('should call open command for file mode', async () => {
            ...
            const testPath = '/path/to/workspace/test.md';
    ...
    describe('セキュリティ: パストラバーサル防止', () => {
        ...
        it('should reject paths with null bytes', async () => {
            ...
            const response = await request(app)
                .post('/api/open-file')
                .send({ path: '/path/to/workspace/test.md\0.txt', mode: 'file' });
