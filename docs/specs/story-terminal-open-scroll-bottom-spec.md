...
- INV-3: Snapshot rendering must continue to pass through `TerminalTransportClient._writeToTerminal()`.
- INV-4: The fix must not change the tmux snapshot API, scrollback size, or terminal history content.
