...
- Source-specific ownership is traceable to four explicit follow-on artifacts: `story-mana-run-receipt-connector-v1` at `docs/stories/story-mana-run-receipt-connector-v1.md`, `story-codex-automations-run-receipt-connector-v1` at `docs/stories/story-codex-automations-run-receipt-connector-v1.md`, `story-github-actions-run-receipt-connector-v1` at `docs/stories/story-github-actions-run-receipt-connector-v1.md`, and `story-salestailor-run-receipt-connector-v1` at `docs/stories/story-salestailor-run-receipt-connector-v1.md`. Their status is pending or implementation-in-progress until source-owned outbox tests and an explicitly approved production canary are complete.
