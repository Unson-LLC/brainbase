...
> Retired by `TSK-WEBRET-002` under `ADR-017-agent-first-product-surface`. The invariants and scenarios below describe the historical prototype and are not current runtime requirements.
