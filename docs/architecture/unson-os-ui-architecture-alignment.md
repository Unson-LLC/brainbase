...
v0 で最初に通す導線は [現場責任者 v0導線運用型ストーリー](../stories/unson-os-lead-workflow-validation-story.md) と [現場責任者 v0導線運用型仕様](../specs/unson-os-lead-v0-operating-model-spec.md) を正本とする。
