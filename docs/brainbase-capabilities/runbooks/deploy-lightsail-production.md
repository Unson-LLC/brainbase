...
The rollback Receipt must report `rollback.database_strategy=forward_only_rls` and `rollback.service_strategy=switch_to_recorded_sha`. Do not describe this procedure as a database down migration.
