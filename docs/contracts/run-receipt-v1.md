...
```json
{
  ...
  "run": {
    ...
    "external_run_id": "mana:lambda:daily-secretary:exec-20260715T090000+0900:attempt:1",
    "status": "success",
  ...
  "delivery": {
    "idempotency_key": "rr1_3ea96060adcb6b9a6ee568ef3a5e557a8137ed0f17b5fd70381fb5bb19ebb264",
    "attempt": 1,
...
The digest shown above is the SHA-256 value for the example tuple `["brainbase","mana","mana:lambda:daily-secretary:exec-20260715T090000+0900:attempt:1"]`; connectors must compute it from the normative canonical tuple algorithm in the Spec.
