...
- 種別: 仕様
- 主題: 現場責任者 v0導線運用型
- 親文書: [UnsonOS 現場責任者ランタイム構成](./unson-os-lead-runtime-architecture.md)
- 派生元: [UnsonOS 現場責任者 v0導線運用型](./unson-os-lead-workflow-validation-story.md)
- 関連文書: [UnsonOS 現場責任者コンソール](./unson-os-lead-control-console.md), [UnsonOS UI×制御面 整合性マトリクス](./unson-os-ui-architecture-alignment.md), [現場責任者 v0実装](./unson-os-lead-v0-implementation-spec.md)
- 置換: なし
