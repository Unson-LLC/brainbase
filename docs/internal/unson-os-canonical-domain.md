...
- 派生元: [エージェント組織基盤ストーリー](./unson-os-agent-org-foundation-story.md)
- 関連文書: [UnsonOS 現場責任者ランタイム構成](./unson-os-lead-runtime-architecture.md), [エージェント組織基盤仕様](./unson-os-agent-org-foundation-spec.md)
- 置換: なし
