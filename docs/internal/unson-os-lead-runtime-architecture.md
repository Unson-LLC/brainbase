...
- 派生元: [現場責任者 v0導線運用型ストーリー](./unson-os-lead-workflow-validation-story.md)
...
UI 面との対応は、[UI×制御面 整合性マトリクス](./unson-os-ui-architecture-alignment.md) を参照する。
...
- [`unson-os-paperclip-adapter-spike.md`](../spikes/unson-os-paperclip-adapter-spike.md)
