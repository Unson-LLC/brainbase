...
- 派生元: [事業群運営ストーリー](./unson-os-portfolio-operator-story.md)
- 関連文書: [経営者・事業責任者・現場責任者の通しシナリオ](./unson-os-ceo-gm-lead-scenario.md), [UnsonOS UI×制御面 整合性マトリクス](./unson-os-ui-architecture-alignment.md)
- 置換: なし
