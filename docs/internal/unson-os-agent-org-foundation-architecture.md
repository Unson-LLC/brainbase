...
- 種別: アーキテクチャ
- 主題: エージェント組織基盤
- 親文書: [エージェント組織基盤ストーリー](./unson-os-agent-org-foundation-story.md)
- 派生元: [エージェント組織基盤ストーリー](./unson-os-agent-org-foundation-story.md)
- 関連文書: [エージェント組織基盤仕様](./unson-os-agent-org-foundation-spec.md), [UnsonOS 正準ドメイン](./unson-os-canonical-domain.md)
- 置換: なし
