...
- `docs/projects/aitm/dashboard-implementation-prompt.md`: 既存実装プロンプト
- `docs/projects/aitm/dashboard-wireframe.md`: 既存ワイヤーフレーム
- `docs/plans/REFACTORING_PLAN.md`: リファクタリング計画
