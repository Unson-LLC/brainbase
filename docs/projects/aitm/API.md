...
**A**: 以下のファイルを参照してください：
- **このファイル**: `/docs/projects/aitm/API.md`
- **コード**: `/server/routes/brainbase.js`
- **USER_GUIDE**: `/docs/projects/aitm/USER_GUIDE.md`
...
- [DESIGN.md](../../architecture/DESIGN.md): UI/UXデザイン仕様
- [REFACTORING_PLAN.md](../../plans/REFACTORING_PLAN.md): リファクタリング計画
