...
> **履歴資料（実装入力には使用しない）**: これは2025-12-31時点の画面案です。記載されたAPI項目やダミーデータ前提は現行契約ではありません。実装時は [API.md](./API.md) と [AITM_Dashboard_Design_Spec.md](./AITM_Dashboard_Design_Spec.md) を正本として使用してください。
