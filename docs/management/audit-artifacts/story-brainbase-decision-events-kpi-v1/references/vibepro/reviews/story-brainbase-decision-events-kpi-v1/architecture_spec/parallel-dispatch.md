...
- Story: story-brainbase-decision-events-kpi-v1
- Stage: architecture_spec
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: 7fc36e0b06c53e91ebd8f8243f2ceb143ab47b55
- User dirty: true
- Raw dirty: true
...
- status: stale
- evidence_key: evk_bae6cc3b25dc2a7f794650f7c2e39bc2
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:3f7a8f86b0cb9fecc578d5c5fe8096dac354b0e6c45437b3933368a1006b2c8e
- current_verification_summary_fingerprint: sha256:e11d0aaa962b58344bb4ef8a3d55e9327f836d4e3625bb8c3447e3bf17847d79
- verification_evidence_updated_at: 2026-07-24T06:21:48.880Z
- current_verification_evidence_updated_at: 2026-07-24T06:58:17.664Z
- preferred_order: -

Reuse key内のverification command timestamps:
- e2e: executed_at=2026-07-24T06:21:48.880Z git_recorded_at=2026-07-24T06:21:48.871Z
- typecheck: executed_at=2026-07-24T06:19:24.773Z git_recorded_at=2026-07-24T06:19:24.770Z
- integration: executed_at=2026-07-24T06:19:23.389Z git_recorded_at=2026-07-24T06:19:23.379Z
- unit: executed_at=2026-07-24T06:19:22.684Z git_recorded_at=2026-07-24T06:19:22.674Z

現在のverification command timestamps:
- unit: executed_at=2026-07-24T06:58:17.664Z git_recorded_at=2026-07-24T06:58:17.651Z
- typecheck: executed_at=2026-07-24T06:57:42.736Z git_recorded_at=2026-07-24T06:57:42.730Z
- integration: executed_at=2026-07-24T06:57:41.872Z git_recorded_at=2026-07-24T06:57:41.857Z
- e2e: executed_at=2026-07-24T06:43:42.787Z git_recorded_at=2026-07-24T06:43:42.783Z

Stale reasons:
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:22ee8b8f9eb1eb90cf0ea2410d059ac3d9fa2d51fde93acbd66ca13fa68a0769 current=sha256:3f7a8f86b0cb9fecc578d5c5fe8096dac354b0e6c45437b3933368a1006b2c8e
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-24T06:19:43.269Z current=2026-07-24T06:21:48.880Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"e2e","executed_at":"2026-07-24T06:19:43.269Z","git_recorded_at":"2026-07-24T06:19:43.260Z"},{"kind":"typecheck","executed_at":"2026-07-24T06:19:24.773Z","git_recorded_at":"2026-07-24T06:19:24.770Z"},{"kind":"integration","executed_at":"2026-07-24T06:19:23.389Z","git_recorded_at":"2026-07-24T06:19:23.379Z"},{"kind":"unit","executed_at":"2026-07-24T06:19:22.684Z","git_recorded_at":"2026-07-24T06:19:22.674Z"}] current=[{"kind":"e2e","executed_at":"2026-07-24T06:21:48.880Z","git_recorded_at":"2026-07-24T06:21:48.871Z"},{"kind":"typecheck","executed_at":"2026-07-24T06:19:24.773Z","git_recorded_at":"2026-07-24T06:19:24.770Z"},{"kind":"integration","executed_at":"2026-07-24T06:19:23.389Z","git_recorded_at":"2026-07-24T06:19:23.379Z"},{"kind":"unit","executed_at":"2026-07-24T06:19:22.684Z","git_recorded_at":"2026-07-24T06:19:22.674Z"}]
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:a2d1e009cc204947b852ec6afcd1c10a2d6ffb1b0aebac909799f5e0887add0d current=sha256:4a9c9d18c6dfae735af0e3f7313318c1d2dcac7474846230b14877a4eee15970
- base_sha: base_sha changed previous=d53d1585e4c5d3af9936e40b55e43025b404faa1 current=f4095c83fa4a10be3ed3cbb13dc6d548b440c4cb
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-brainbase-decision-events-kpi-v1 --stage architecture_spec` を実行し、その後 `vibepro pr prepare . --story-id story-brainbase-decision-events-kpi-v1 --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-brainbase-decision-events-kpi-v1/evidence-plan.summary.json`（bounded summary。まずこれを読む）。full artifact `evidence-plan.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-brainbase-decision-events-kpi-v1/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-brainbase-decision-events-kpi-v1/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-brainbase-decision-events-kpi-v1/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-brainbase-decision-events-kpi-v1/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-brainbase-decision-events-kpi-v1/split-plan.summary.json`（bounded summary。まずこれを読む）。full artifact `split-plan.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-brainbase-decision-events-kpi-v1/architecture_spec/review-request-architecture_boundary.md`
...
`vibepro review record . --id story-brainbase-decision-events-kpi-v1 --stage architecture_spec --role architecture_boundary --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-brainbase-decision-events-kpi-v1 --stage architecture_spec --role architecture_boundary --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-brainbase-decision-events-kpi-v1 --stage architecture_spec --role architecture_boundary --agent-system <codex|claude_code> --agent-id "<subagent-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-brainbase-decision-events-kpi-v1 --stage architecture_spec --role architecture_boundary --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
