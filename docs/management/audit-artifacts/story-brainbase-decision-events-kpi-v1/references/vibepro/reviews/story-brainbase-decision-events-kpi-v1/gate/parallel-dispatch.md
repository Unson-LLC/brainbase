...
- status: fresh
- evidence_key: evk_b786f4da07c87be2dcac6b59cb618185
- first_input: true
- reason: Fresh evidence summary/index can be used as first review input.
- verification_summary_fingerprint: sha256:47b76a954078a644dc39695b99c0efef14b57defabea8b407de2f644203ed6f0
- current_verification_summary_fingerprint: sha256:47b76a954078a644dc39695b99c0efef14b57defabea8b407de2f644203ed6f0
- verification_evidence_updated_at: 2026-07-24T07:33:52.791Z
- current_verification_evidence_updated_at: 2026-07-24T07:33:52.791Z
- preferred_order: .vibepro/pr/story-brainbase-decision-events-kpi-v1/evidence-reuse.json, .vibepro/pr/story-brainbase-decision-events-kpi-v1/decision-index.json, .vibepro/pr/story-brainbase-decision-events-kpi-v1/evidence-plan.json, .vibepro/pr/story-brainbase-decision-events-kpi-v1/pr-prepare.json
...
- e2e: executed_at=2026-07-24T07:33:52.056Z git_recorded_at=2026-07-24T07:33:52.053Z
- integration: executed_at=2026-07-24T07:33:51.351Z git_recorded_at=2026-07-24T07:33:51.342Z
- unit: executed_at=2026-07-24T07:33:50.647Z git_recorded_at=2026-07-24T07:33:50.644Z
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-brainbase-decision-events-kpi-v1 --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-brainbase-decision-events-kpi-v1 --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-brainbase-decision-events-kpi-v1/gate/review-request-gate_evidence.md`
...
`vibepro review authorize . --id story-brainbase-decision-events-kpi-v1 --stage gate --role gate_evidence --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-brainbase-decision-events-kpi-v1 --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-brainbase-decision-events-kpi-v1 --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
