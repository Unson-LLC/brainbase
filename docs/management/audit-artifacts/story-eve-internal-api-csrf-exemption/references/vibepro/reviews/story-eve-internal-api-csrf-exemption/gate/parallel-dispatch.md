...
- Current head: d7b7e9e764614599ec1eb5180c466053247bd6ec
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_7c807eb29187a8ae34ca71c79dd99f8c
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:48811366f5b3a6e125243fb945f676f5fb834aed8fa82f07c2a74e9426457675
- current_verification_summary_fingerprint: sha256:48811366f5b3a6e125243fb945f676f5fb834aed8fa82f07c2a74e9426457675
- verification_evidence_updated_at: 2026-07-13T19:42:39.077Z
- current_verification_evidence_updated_at: 2026-07-13T19:42:39.077Z
- preferred_order: -

Reuse key内のverification command timestamps:
- build: executed_at=2026-07-13T19:42:39.077Z git_recorded_at=2026-07-13T19:42:39.075Z
- typecheck: executed_at=2026-07-13T19:42:24.935Z git_recorded_at=2026-07-13T19:42:24.934Z
- e2e: executed_at=2026-07-13T19:42:12.634Z git_recorded_at=2026-07-13T19:42:12.629Z
- integration: executed_at=2026-07-13T19:41:56.756Z git_recorded_at=2026-07-13T19:41:56.755Z
- unit: executed_at=2026-07-13T19:41:45.749Z git_recorded_at=2026-07-13T19:41:45.744Z
...
Stale reasons:
- spec_fingerprint: spec_fingerprint changed previous=sha256:e06783956439eb60e79c005eb929ae9186fe03550daae388d3e47821b25af73c current=sha256:da57443f26103cde47ba4b5e2014797cf348da9770b36b88b666077cfe16868d
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:f5a6c0bfa8ed40d5d976144445e03002810128d486457598093505cfea3e9496 current=sha256:ebfa1f275b81c2c3939b15113b56b54209deff1238c827c2f5b1535c995d8757
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-eve-internal-api-csrf-exemption --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-eve-internal-api-csrf-exemption --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-eve-internal-api-csrf-exemption/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-eve-internal-api-csrf-exemption/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-eve-internal-api-csrf-exemption/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-eve-internal-api-csrf-exemption --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-eve-internal-api-csrf-exemption --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-eve-internal-api-csrf-exemption --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
