...
| 項目 | 内容 |
|------|------|
| Story | 本番internal API key経路のCSRF除外 |
| Story ID | story-eve-internal-api-csrf-exemption |
| Run ID | 2026-07-13T190723Z |
| Gate | needs_review |
| タスク数 | 3 |

| ID | Finding | 優先度 | 対象 | 方針 | 状態 |
|----|---------|--------|------|------|------|
| story-eve-internal-api-csrf-exemption-source-alignment-review | - | high | 0件 | source-alignment-review | done |
| VP-TASK-FLOW-006 | VP-FLOW-006 | high | 22件 | manual-review | todo |
| VP-TASK-STATIC-003 | VP-STATIC-003 | high | 41件 | manual-review | todo |

## story-eve-internal-api-csrf-exemption-source-alignment-review: Story/Spec/ADR不整合をレビューする

- Source: source_alignment_finding / story-eve-internal-api-csrf-exemption-source-alignment-review
