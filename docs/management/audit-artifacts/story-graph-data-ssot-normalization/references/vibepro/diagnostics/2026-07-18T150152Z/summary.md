...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-18T150152Z |
| Story | Graphデータ正本の重複・欠落を可逆的に正規化する |
| Story ID | story-graph-data-ssot-normalization |
| 診断フェーズ | design_input |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=88dd9d39aee5 dirty=false |
| 種別 | web_app |
| 描画方式 | react |
| 適用チェック | secrets, xss, dependency-graph, component-style, code-quality, database-access |
| graphify nodes | 6654 |
| graphify edges | 13750 |
| 共通スキャン対象 | 3372件 |
| 秘密情報候補 | 30件 (block: 0件, review: 0件, info: 30件) |
| XSSリスク候補 | 234件 (block: 0件, review: 120件, info: 114件) |
| UI旧トークン候補 | 76件 (block: 0件, review: 76件, info: 0件) |
| UI操作信頼性候補 | 119件 (block: 0件, review: 119件, info: 0件) |
