...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-eve-meeting-note-pull-reconciler --stage preview` を実行し、その後 `vibepro pr prepare . --story-id story-eve-meeting-note-pull-reconciler --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-eve-meeting-note-pull-reconciler/preview/review-request-network_runtime.md`
...
`vibepro review start . --id story-eve-meeting-note-pull-reconciler --stage preview --role network_runtime --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-eve-meeting-note-pull-reconciler --stage preview --role network_runtime --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-eve-meeting-note-pull-reconciler/preview/review-request-human_usability.md`
...
Lifecycle start command:
`vibepro review start . --id story-eve-meeting-note-pull-reconciler --stage preview --role human_usability --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-eve-meeting-note-pull-reconciler --stage preview --role human_usability --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
