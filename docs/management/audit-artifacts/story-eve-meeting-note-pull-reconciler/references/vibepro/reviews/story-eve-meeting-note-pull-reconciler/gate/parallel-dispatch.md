...
- status: fresh
- evidence_key: evk_a8cd373116c54911d5fe515bc6e09c0e
- first_input: true
- reason: Fresh evidence summary/index can be used as first review input.
- verification_summary_fingerprint: sha256:31fadf42a72f9b976c62332f7a0e77c974e993ac13a119668a5750a503535321
- current_verification_summary_fingerprint: sha256:31fadf42a72f9b976c62332f7a0e77c974e993ac13a119668a5750a503535321
- verification_evidence_updated_at: 2026-07-11T13:54:07.605Z
- current_verification_evidence_updated_at: 2026-07-11T13:54:07.605Z
- preferred_order: .vibepro/pr/story-eve-meeting-note-pull-reconciler/evidence-reuse.json, .vibepro/pr/story-eve-meeting-note-pull-reconciler/decision-index.json, .vibepro/pr/story-eve-meeting-note-pull-reconciler/evidence-plan.json, .vibepro/pr/story-eve-meeting-note-pull-reconciler/pr-prepare.json, .vibepro/pr/story-eve-meeting-note-pull-reconciler/gate-dag.json
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-eve-meeting-note-pull-reconciler --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-eve-meeting-note-pull-reconciler --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-eve-meeting-note-pull-reconciler/gate/review-request-gate_evidence.md`
...
`vibepro review start . --id story-eve-meeting-note-pull-reconciler --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-eve-meeting-note-pull-reconciler --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-eve-meeting-note-pull-reconciler/gate/review-request-release_risk.md`
...
Lifecycle start command:
`vibepro review start . --id story-eve-meeting-note-pull-reconciler --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-eve-meeting-note-pull-reconciler --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
