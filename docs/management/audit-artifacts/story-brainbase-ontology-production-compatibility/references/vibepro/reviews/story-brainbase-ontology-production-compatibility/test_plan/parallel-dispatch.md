...
- status: stale
- evidence_key: evk_edd0ddaa231448855f57752d134badad
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:e3ef300d7bb8abc6e6c782e00262542d3c66a78657ab4ffeb43944e17e90eb8f
- current_verification_summary_fingerprint: sha256:8fbbd0c4d8a7949e36cc9eb3565505f1d94958b7fb4242de87bb127c3e484273
- verification_evidence_updated_at: 2026-08-02T17:57:04.502Z
- current_verification_evidence_updated_at: 2026-08-02T18:11:57.046Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-08-02T17:57:04.502Z git_recorded_at=2026-08-02T17:57:04.487Z
- integration: executed_at=2026-08-02T17:46:30.749Z git_recorded_at=2026-08-02T17:46:32.097Z
- e2e: executed_at=2026-08-02T17:42:17.890Z git_recorded_at=2026-08-02T17:42:18.285Z
- typecheck: executed_at=2026-08-02T17:37:51.423Z git_recorded_at=2026-08-02T17:37:54.596Z
...
Stale reasons:
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:5e815e3622653db1581f965e44bf851f412af23a1703b6e298f30ff66bab9dd0 current=sha256:fc46043a7e206b9740d5e00cd767de5e183ca5fd4337784149a5b230bad2b2c2
- head_sha: review prepare current HEAD does not match evidence key HEAD previous=152842e4a8dc5c646090e472fa726d294c6a5d85 current=560f7212e2b0186539327f8c9fe5d5e5106f3d45
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:e3ef300d7bb8abc6e6c782e00262542d3c66a78657ab4ffeb43944e17e90eb8f current=sha256:8fbbd0c4d8a7949e36cc9eb3565505f1d94958b7fb4242de87bb127c3e484273
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-08-02T17:57:04.502Z current=2026-08-02T18:11:57.046Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"unit","executed_at":"2026-08-02T17:57:04.502Z","git_recorded_at":"2026-08-02T17:57:04.487Z"},{"kind":"integration","executed_at":"2026-08-02T17:46:30.749Z","git_recorded_at":"2026-08-02T17:46:32.097Z"},{"kind":"e2e","executed_at":"2026-08-02T17:42:17.890Z","git_recorded_at":"2026-08-02T17:42:18.285Z"},{"kind":"typecheck","executed_at":"2026-08-02T17:37:51.423Z","git_recorded_at":"2026-08-02T17:37:54.596Z"}] current=[{"kind":"e2e","executed_at":"2026-08-02T18:11:57.046Z","git_recorded_at":"2026-08-02T18:11:57.031Z"},{"kind":"typecheck","executed_at":"2026-08-02T18:11:42.401Z","git_recorded_at":"2026-08-02T18:11:43.203Z"},{"kind":"integration","executed_at":"2026-08-02T18:08:38.779Z","git_recorded_at":"2026-08-02T18:08:39.771Z"},{"kind":"unit","executed_at":"2026-08-02T18:07:45.866Z","git_recorded_at":"2026-08-02T18:07:46.859Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-brainbase-ontology-production-compatibility --stage test_plan` を実行し、その後 `vibepro pr prepare . --story-id story-brainbase-ontology-production-compatibility --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-brainbase-ontology-production-compatibility/test_plan/review-request-unit_integration.md`
...
`vibepro review record . --id story-brainbase-ontology-production-compatibility --stage test_plan --role unit_integration --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-brainbase-ontology-production-compatibility --stage test_plan --role unit_integration --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-brainbase-ontology-production-compatibility --stage test_plan --role unit_integration --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-brainbase-ontology-production-compatibility --stage test_plan --role unit_integration --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
...
## Subagent 2: test_plan:e2e_ux

Review request:
`.vibepro/reviews/story-brainbase-ontology-production-compatibility/test_plan/review-request-e2e_ux.md`

Prompt:
上記review requestを読み、`test_plan:e2e_ux` reviewだけを実行してください。すべてのmandatory review lensを含めます。fileは編集しません。返却JSONには `status`, `summary`, `findings`, `inspection_summary`, 任意の `inspection_evidence`, `inspection_inputs`, `judgment_delta` を含めます。`inspection_inputs` には実際に確認したsource、test、Story、Spec、contract、config fileを列挙し、review-request pathや生成された `.vibepro` artifactだけをcontent surfaceとして返してはいけません。


subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-brainbase-ontology-production-compatibility --stage test_plan --role e2e_ux --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-brainbase-ontology-production-compatibility --stage test_plan --role e2e_ux --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-brainbase-ontology-production-compatibility --stage test_plan --role e2e_ux --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-brainbase-ontology-production-compatibility --stage test_plan --role e2e_ux --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
...
## Subagent 3: test_plan:gate_coverage

Review request:
`.vibepro/reviews/story-brainbase-ontology-production-compatibility/test_plan/review-request-gate_coverage.md`

Prompt:
上記review requestを読み、`test_plan:gate_coverage` reviewだけを実行してください。すべてのmandatory review lensを含めます。fileは編集しません。返却JSONには `status`, `summary`, `findings`, `inspection_summary`, 任意の `inspection_evidence`, `inspection_inputs`, `judgment_delta` を含めます。`inspection_inputs` には実際に確認したsource、test、Story、Spec、contract、config fileを列挙し、review-request pathや生成された `.vibepro` artifactだけをcontent surfaceとして返してはいけません。


subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-brainbase-ontology-production-compatibility --stage test_plan --role gate_coverage --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-brainbase-ontology-production-compatibility --stage test_plan --role gate_coverage --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-brainbase-ontology-production-compatibility --stage test_plan --role gate_coverage --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-brainbase-ontology-production-compatibility --stage test_plan --role gate_coverage --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
