...
|----|---------|--------|------|------|------|
| story-brainbase-ontology-production-compatibility-source-alignment-review | - | high | 0件 | source-alignment-review | done |
| VP-TASK-FLOW-006 | VP-FLOW-006 | high | 20件 | manual-review | todo |
| VP-TASK-STATIC-003 | VP-STATIC-003 | high | 34件 | manual-review | todo |

## story-brainbase-ontology-production-compatibility-source-alignment-review: Story/Spec/ADR不整合をレビューする

- Source: source_alignment_finding / story-brainbase-ontology-production-compatibility-source-alignment-review
