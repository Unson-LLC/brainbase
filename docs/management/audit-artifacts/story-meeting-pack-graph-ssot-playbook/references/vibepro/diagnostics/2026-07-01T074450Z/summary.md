...
| Story | Meeting Pack Graph SSOT Playbook |
| Story ID | story-meeting-pack-graph-ssot-playbook |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=ffbea812b8e2 dirty=false |
| 種別 | web_app |
| 描画方式 | react |
| 適用チェック | secrets, xss, dependency-graph, component-style, code-quality, database-access |
| graphify nodes | 6276 |
| graphify edges | 12976 |
| 共通スキャン対象 | 2555件 |
| 秘密情報候補 | 30件 (block: 0件, review: 0件, info: 30件) |
| XSSリスク候補 | 266件 (block: 0件, review: 149件, info: 117件) |
