...
- public/modules/settings/settings-core.js:622 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `編集` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:623 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `削除` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:632 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `クリア` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:659 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `保存` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:660 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `削除` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:840 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `編集` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:841 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `削除` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:851 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `クリア` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:872 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `保存` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:873 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `削除` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1096 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `Configure` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1141 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `div` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1142 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `div` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1143 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `button` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1176 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `div` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1177 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `div` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1178 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `button` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1184 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `div` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1185 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `div` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1186 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `button` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1207 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `保存` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1217 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `クリア` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1245 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `保存` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1246 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `削除` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1316 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `編集` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1317 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `削除` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1326 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `クリア` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1350 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `保存` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1351 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `削除` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1412 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `編集` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1413 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `削除` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
- public/modules/settings/settings-core.js:1878 interactive_element_without_contract severity=High gate_effect=review クリック可能に見える `保存` が、onClick/href/submit/disabled/準備中表示などの操作契約を持っていない。
