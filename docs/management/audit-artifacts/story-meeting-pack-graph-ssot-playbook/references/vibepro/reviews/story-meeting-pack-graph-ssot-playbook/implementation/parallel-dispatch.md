...
- Current head: 3dc8028302a1632825841a1c87b9f26ccf7a1bad
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_1d6b27d1f968dd263ed0ec64c0a0234f
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:2620392dc180c1e3cfeaa674172777d1f9d911045b5cf08605e5f9da72c16758
- current_verification_summary_fingerprint: sha256:2620392dc180c1e3cfeaa674172777d1f9d911045b5cf08605e5f9da72c16758
- verification_evidence_updated_at: 2026-07-01T15:15:17.265Z
- current_verification_evidence_updated_at: 2026-07-01T15:15:17.265Z
- preferred_order: -

Reuse key内のverification command timestamps:
- integration: executed_at=2026-07-01T15:15:17.265Z git_recorded_at=2026-07-01T15:15:17.264Z
- e2e: executed_at=2026-07-01T15:14:46.863Z git_recorded_at=2026-07-01T15:14:46.862Z
- unit: executed_at=2026-07-01T15:14:46.846Z git_recorded_at=2026-07-01T15:14:46.844Z
...
Stale reasons:
- evidence_key: evidence key changed previous=evk_23bc48798e8aa522734e848eb55ae419 current=evk_1d6b27d1f968dd263ed0ec64c0a0234f
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-meeting-pack-graph-ssot-playbook --stage implementation` を実行し、その後 `vibepro pr prepare . --story-id story-meeting-pack-graph-ssot-playbook --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-meeting-pack-graph-ssot-playbook/implementation/review-request-runtime_contract.md`
...
`vibepro review record . --id story-meeting-pack-graph-ssot-playbook --stage implementation --role runtime_contract --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-meeting-pack-graph-ssot-playbook --stage implementation --role runtime_contract --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-meeting-pack-graph-ssot-playbook --stage implementation --role runtime_contract --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-meeting-pack-graph-ssot-playbook/implementation/review-request-ux_completion.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-meeting-pack-graph-ssot-playbook --stage implementation --role ux_completion --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-meeting-pack-graph-ssot-playbook --stage implementation --role ux_completion --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-meeting-pack-graph-ssot-playbook --stage implementation --role ux_completion --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
