...
- Current head: 8c2924e1632fe9ce321442f202961dd151663008
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_594681454915a862e784a6d734d93af2
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:7a42e33ae60d0880b634cfa550fa995b0fe2f430c7da979aacfa9ccfd32cd213
- current_verification_summary_fingerprint: sha256:7a42e33ae60d0880b634cfa550fa995b0fe2f430c7da979aacfa9ccfd32cd213
- verification_evidence_updated_at: 2026-07-01T14:53:28.080Z
- current_verification_evidence_updated_at: 2026-07-01T14:53:28.080Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-01T14:53:28.080Z git_recorded_at=2026-07-01T14:53:28.079Z
- e2e: executed_at=2026-07-01T14:53:20.049Z git_recorded_at=2026-07-01T14:53:20.044Z
- integration: executed_at=2026-07-01T09:46:37.543Z git_recorded_at=2026-07-01T09:46:37.540Z
...
Stale reasons:
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:a829c06920bc3f3180f9e0727fc9ab2696d37d4a2b57c6b857183c156fed33ad current=sha256:cb3d704f881302845daab6619919325aa185f54d58d0a2dd58468e0ca43233eb
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-meeting-pack-graph-ssot-playbook --stage test_plan` を実行し、その後 `vibepro pr prepare . --story-id story-meeting-pack-graph-ssot-playbook --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-meeting-pack-graph-ssot-playbook/test_plan/review-request-e2e_ux.md`
...
`vibepro review record . --id story-meeting-pack-graph-ssot-playbook --stage test_plan --role e2e_ux --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-meeting-pack-graph-ssot-playbook --stage test_plan --role e2e_ux --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-meeting-pack-graph-ssot-playbook --stage test_plan --role e2e_ux --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-meeting-pack-graph-ssot-playbook/test_plan/review-request-gate_coverage.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-meeting-pack-graph-ssot-playbook --stage test_plan --role gate_coverage --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-meeting-pack-graph-ssot-playbook --stage test_plan --role gate_coverage --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-meeting-pack-graph-ssot-playbook --stage test_plan --role gate_coverage --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
