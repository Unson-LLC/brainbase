...
- status: stale
- evidence_key: evk_1259072a2f42d065900114619e998eaf
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:7c36808706013c17b13b839b8f22755cccaa45244fd8499ecfa6e9d2dc302120
- current_verification_summary_fingerprint: sha256:7c36808706013c17b13b839b8f22755cccaa45244fd8499ecfa6e9d2dc302120
- verification_evidence_updated_at: 2026-07-11T02:40:25.914Z
- current_verification_evidence_updated_at: 2026-07-11T02:40:25.914Z
- preferred_order: -

Reuse key内のverification command timestamps:
- integration: executed_at=2026-07-11T02:40:25.914Z git_recorded_at=2026-07-11T02:40:25.888Z
...
Stale reasons:
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:5d0a223d0652b4ff5af1c89eb4b47e6101ccdc41f956526fbf0bd91103eb4cec current=sha256:553906b114ad682a4f56c2d87d98d451b53a7b58a6430c196b7874d6a941dbe1
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-eve-dispatch-handoff-transcript-context --stage implementation` を実行し、その後 `vibepro pr prepare . --story-id story-eve-dispatch-handoff-transcript-context --base <base-branch>` で次stageへ進む。
...
`vibepro review start . --id story-eve-dispatch-handoff-transcript-context --stage implementation --role ux_completion --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-eve-dispatch-handoff-transcript-context --stage implementation --role ux_completion --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
