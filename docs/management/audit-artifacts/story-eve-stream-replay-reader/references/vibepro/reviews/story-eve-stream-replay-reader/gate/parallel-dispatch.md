...
- Story: story-eve-stream-replay-reader
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: c7e55cafa65b933742cadb0ca7786314daa63f94
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_be950f5e19fafa94b0a84c6732a1b86d
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:dc365eb7012bf67f7a47e3b60863db408b8f8fb47ab77bfd94ab21b2900ffea2
- current_verification_summary_fingerprint: sha256:dc365eb7012bf67f7a47e3b60863db408b8f8fb47ab77bfd94ab21b2900ffea2
- verification_evidence_updated_at: 2026-07-11T15:43:02.238Z
- current_verification_evidence_updated_at: 2026-07-11T15:43:02.238Z
- preferred_order: -

Reuse key内のverification command timestamps:
- integration: executed_at=2026-07-11T15:43:02.238Z git_recorded_at=2026-07-11T15:43:02.212Z
- e2e: executed_at=2026-07-11T15:42:24.470Z git_recorded_at=2026-07-11T15:42:24.442Z
- unit: executed_at=2026-07-11T15:42:05.891Z git_recorded_at=2026-07-11T15:42:05.862Z
...
Stale reasons:
- head_sha: head_sha changed previous=8da4dd1cc48dc5de915b9f82a25c356270077dcb current=c7e55cafa65b933742cadb0ca7786314daa63f94
- spec_fingerprint: spec_fingerprint changed previous=sha256:67a7314ce38beff274b225080a82845a80258c0b13aad80c6c6be3b1c07789c0 current=sha256:7bed1fde609313d9609f25d08e99dd5d63d8b7fa96d9a853af51547532da3b50
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:09160cdf7e7db7730105ce2485ddc563048b27c19e49ef6acafa59de98f6c2ef current=sha256:dc365eb7012bf67f7a47e3b60863db408b8f8fb47ab77bfd94ab21b2900ffea2
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=- current=2026-07-11T15:43:02.238Z
- verification_command_timestamps: verification_command_timestamps changed previous=[] current=[{"kind":"integration","executed_at":"2026-07-11T15:43:02.238Z","git_recorded_at":"2026-07-11T15:43:02.212Z"},{"kind":"e2e","executed_at":"2026-07-11T15:42:24.470Z","git_recorded_at":"2026-07-11T15:42:24.442Z"},{"kind":"unit","executed_at":"2026-07-11T15:42:05.891Z","git_recorded_at":"2026-07-11T15:42:05.862Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-eve-stream-replay-reader --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-eve-stream-replay-reader --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-eve-stream-replay-reader/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-eve-stream-replay-reader/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-eve-stream-replay-reader/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-eve-stream-replay-reader/gate-dag.summary.json`（bounded summary。まずこれを読む）。full artifact `gate-dag.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-eve-stream-replay-reader/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-eve-stream-replay-reader --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-eve-stream-replay-reader --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-eve-stream-replay-reader --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
