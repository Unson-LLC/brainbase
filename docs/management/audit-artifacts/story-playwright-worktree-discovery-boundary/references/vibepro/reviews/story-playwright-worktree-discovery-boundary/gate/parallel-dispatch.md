...
- Story: story-playwright-worktree-discovery-boundary
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 3
- Current head: 336faa2cc7cccbaa7e04706c4af0fb6027e9c0f2
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_ba68d45247556caf9eda016185effa78
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:93675c76ddcbceb30a340da98f051a619f05c8781b43b835f11c31c4bcde013f
- current_verification_summary_fingerprint: sha256:93675c76ddcbceb30a340da98f051a619f05c8781b43b835f11c31c4bcde013f
- verification_evidence_updated_at: 2026-07-17T14:07:01.078Z
- current_verification_evidence_updated_at: 2026-07-17T14:07:01.078Z
- preferred_order: -

Reuse key内のverification command timestamps:
- typecheck: executed_at=2026-07-17T14:07:01.078Z git_recorded_at=2026-07-17T14:07:01.077Z
- unit: executed_at=2026-07-17T14:06:44.295Z git_recorded_at=2026-07-17T14:06:44.293Z
- integration: executed_at=2026-07-17T14:06:20.673Z git_recorded_at=2026-07-17T14:06:20.671Z
- e2e: executed_at=2026-07-17T14:06:20.660Z git_recorded_at=2026-07-17T14:06:20.655Z
...
Stale reasons:
- spec_fingerprint: spec_fingerprint changed previous=sha256:0ce350255e82eff78c2e412cb1c2ad5b05d7f4cfc36f694dec91551a17b534b8 current=sha256:e318f6b9adde4bb4cf5f3fed8abe231c430b7790fd93374d6ce278e208dc19d9
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:c358b5c61c5da1529aaf99883d3a800d3d337b5380b8d198c4af85c53f236e88 current=sha256:93675c76ddcbceb30a340da98f051a619f05c8781b43b835f11c31c4bcde013f
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-17T13:55:31.472Z current=2026-07-17T14:07:01.078Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"typecheck","executed_at":"2026-07-17T13:55:31.472Z","git_recorded_at":"2026-07-17T13:55:31.471Z"},{"kind":"integration","executed_at":"2026-07-17T13:55:24.113Z","git_recorded_at":"2026-07-17T13:55:24.112Z"},{"kind":"e2e","executed_at":"2026-07-17T13:55:16.868Z","git_recorded_at":"2026-07-17T13:55:16.867Z"},{"kind":"unit","executed_at":"2026-07-17T13:55:09.681Z","git_recorded_at":"2026-07-17T13:55:09.680Z"}] current=[{"kind":"typecheck","executed_at":"2026-07-17T14:07:01.078Z","git_recorded_at":"2026-07-17T14:07:01.077Z"},{"kind":"unit","executed_at":"2026-07-17T14:06:44.295Z","git_recorded_at":"2026-07-17T14:06:44.293Z"},{"kind":"integration","executed_at":"2026-07-17T14:06:20.673Z","git_recorded_at":"2026-07-17T14:06:20.671Z"},{"kind":"e2e","executed_at":"2026-07-17T14:06:20.660Z","git_recorded_at":"2026-07-17T14:06:20.655Z"}]
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:08298e57ce0576287a936b9d353d92836f6fb75339da28216554f780506247ca current=sha256:3cdefbde4cf5bbd712901535a9656c2b585fc94a911fb0a3a3c1be770beee1c5
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-playwright-worktree-discovery-boundary --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-playwright-worktree-discovery-boundary --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-playwright-worktree-discovery-boundary/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-playwright-worktree-discovery-boundary/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-playwright-worktree-discovery-boundary/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-playwright-worktree-discovery-boundary/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-playwright-worktree-discovery-boundary/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-playwright-worktree-discovery-boundary --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-playwright-worktree-discovery-boundary --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-playwright-worktree-discovery-boundary --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-playwright-worktree-discovery-boundary/gate/review-request-pr_split_scope.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-playwright-worktree-discovery-boundary --stage gate --role pr_split_scope --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-playwright-worktree-discovery-boundary --stage gate --role pr_split_scope --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-playwright-worktree-discovery-boundary --stage gate --role pr_split_scope --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-playwright-worktree-discovery-boundary/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-playwright-worktree-discovery-boundary --stage gate --role release_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-playwright-worktree-discovery-boundary --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-playwright-worktree-discovery-boundary --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
