...
| 項目 | 内容 |
|------|------|
| Story | Playwrightの探索対象をcanonical E2Eへ限定する |
| Story ID | story-playwright-worktree-discovery-boundary |
| Run ID | 2026-07-17T135606Z |
| Gate | needs_review |
| タスク数 | 3 |

| ID | Finding | 優先度 | 対象 | 方針 | 状態 |
|----|---------|--------|------|------|------|
| story-playwright-worktree-discovery-boundary-source-alignment-review | - | high | 0件 | source-alignment-review | done |
| VP-TASK-FLOW-006 | VP-FLOW-006 | high | 22件 | manual-review | todo |
| VP-TASK-STATIC-003 | VP-STATIC-003 | high | 41件 | manual-review | todo |

## story-playwright-worktree-discovery-boundary-source-alignment-review: Story/Spec/ADR不整合をレビューする

- Source: source_alignment_finding / story-playwright-worktree-discovery-boundary-source-alignment-review
