...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-04T201215Z |
| Story | Meeting Source同期範囲をBrainbase runtime policyで解決する |
| Story ID | story-meeting-source-runtime-sync-policy |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=202599f7082d dirty=true |
| 種別 | web_app |
| 描画方式 | react |
| 適用チェック | secrets, xss, dependency-graph, component-style, code-quality, database-access |
| graphify nodes | 6420 |
| graphify edges | 13390 |
| 共通スキャン対象 | 2711件 |
