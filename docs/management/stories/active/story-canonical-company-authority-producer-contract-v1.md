...
### AC-002: CanonicalExecutionContextV1のschemaとwireを固定する
...
### AC-003: canonical JSONと署名 profileを固定する
...
### AC-005: canonical errorとfail-closed negative matrixを固定する
...
### AC-006: synthetic fixtureとmanifest digestを固定する
