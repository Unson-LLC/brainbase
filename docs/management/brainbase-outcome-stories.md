...
| knowledge-lifecycle | 一部完了 | AC-1の本文・scope・責任者・有効期間改訂、CAS競合、変更理由・前後snapshot履歴、廃止/関連解除。AC-2の正式なsupersedes関係、両判断の権限・版競合、発効時失効、冪等監査receipt | AC-3の共有利用先影響表示、本番DB/Graph E2E |
