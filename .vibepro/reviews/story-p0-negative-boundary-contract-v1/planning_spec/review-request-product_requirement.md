...
- dependency domains: story, spec, policy, public_contract
- previous status: missing
- previous binding: -
- open finding ids: -
- instruction: Review the role-specific decision dependencies and mandatory lenses.


## レビュー観点
実装がユーザー価値と明示された受け入れ基準を保っているか確認する。
