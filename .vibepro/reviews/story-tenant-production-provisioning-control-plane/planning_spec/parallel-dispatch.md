...
6. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-tenant-production-provisioning-control-plane --stage planning_spec` を実行し、その後 `vibepro pr prepare . --story-id story-tenant-production-provisioning-control-plane --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-tenant-production-provisioning-control-plane/planning_spec/review-request-product_requirement.md`
...
Review request:
`.vibepro/reviews/story-tenant-production-provisioning-control-plane/planning_spec/review-request-architecture_boundary.md`
...
Review request:
`.vibepro/reviews/story-tenant-production-provisioning-control-plane/planning_spec/review-request-spec_consistency.md`
