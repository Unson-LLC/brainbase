...
/**
 * @typedef {Object} GoogleCalendarTime
...
/**
 * @typedef {Object} GoogleCalendarEventInput
 * @property {string} [summary]
 * @property {GoogleCalendarTime | null} [start]
 * @property {GoogleCalendarTime | null} [end]
 * @property {string} [id]
 * @property {string} [calendarId]
 */

/**
 * @typedef {import('./google-calendar-utils.js').GoogleCalendarEventLike & {
 *   id: string,
 *   end: string | null,
 *   title: string,
 *   source: string,
...
export class CalendarEventConverter {
     ...
     * @param {GoogleCalendarEventInput} gcEvent - Google Calendar event from MCP
     * @returns {KiroCalendarEvent} - Kiro format event
     */
     ...
     * @param {GoogleCalendarEventInput[]} gcEvents - Array of Google Calendar events
     * @returns {KiroCalendarEvent[]} - Array of Kiro format events
     */
     ...
     * @param {GoogleCalendarTime | null | undefined} timeObj - { dateTime, date, timeZone }
     ...
     * @param {KiroCalendarEvent[]} existingEvents - Existing Kiro events
     * @param {KiroCalendarEvent} newEvent - New event to check
     ...
     * @param {KiroCalendarEvent[]} events - Kiro format events
     * @returns {KiroCalendarEvent[]} - Events with start times
     */
     ...
     * @param {KiroCalendarEvent[]} events - Kiro format events
     * @returns {KiroCalendarEvent[]} - Sorted events
     */
