...
/** @typedef {{ useKiroFormat?: boolean, googleCalendarService?: { isConfigured?: () => boolean, listEventsForDate: (date: string) => Promise<ScheduleEvent[]> } | null }} ScheduleParserOptions */
/** @typedef {{ id?: string, start?: string | null, end?: string | null, title?: string, task?: string, source?: string | null, calendarId?: string | null, completed?: boolean, allDay?: boolean }} ScheduleEvent */
/** @typedef {{ start: string | null, end: string | null, task: string, isOhayo?: boolean, isWorkTime?: boolean, completed?: boolean, allDay?: boolean, source?: string | null, calendarId?: string | null }} LegacyScheduleItem */
...
export class ScheduleParser {
    ...
    async getSchedule(date) {
        ...
        try {
            ...
            logger.error('Error reading schedule file:', error);
            return this._mergeLegacySchedule(date, {
                date,
                events: [],
                items: [],
    ...
    /**
     * @param {ScheduleEvent[]} [existingEvents]
     * @param {ScheduleEvent[]} [googleEvents]
     ...
     * @param {string} date - Date in YYYY-MM-DD format
     * @param {ScheduleEvent} eventData - Event data
     * @returns {Promise<{ duplicate: boolean, event: ScheduleEvent | null }>} - Created event
     */
     ...
     * @param {Partial<ScheduleEvent>} updates
     * @returns {Promise<{ success: boolean, event?: ScheduleEvent, error?: string }>}
     */
